...
[ArkAnalyzer](../../../../globals.md) / [ts](../README.md) / InstantiableType

# Interface: InstantiableType

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:2886
...
- [`ConditionalType`](ConditionalType.md)
- [`TemplateLiteralType`](TemplateLiteralType.md)
- [`StringMappingType`](StringMappingType.md)
- [`SubstitutionType`](SubstitutionType.md)
