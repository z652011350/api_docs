...
[ArkAnalyzer](../../../../globals.md) / [ts](../README.md) / JSDocNameReference

# Interface: JSDocNameReference

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1860
...
> `readonly` **kind**: [`JSDocNameReference`](../enumerations/SyntaxKind.md#jsdocnamereference)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1861
...
> `readonly` **name**: [`EntityName`](../type-aliases/EntityName.md) \| [`JSDocMemberName`](JSDocMemberName.md)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1862
