...
[ArkAnalyzer](../../../../globals.md) / [ts](../README.md) / CaseBlock

# Interface: CaseBlock

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1567
...
> `readonly` **clauses**: [`NodeArray`](NodeArray.md)\<[`CaseOrDefaultClause`](../type-aliases/CaseOrDefaultClause.md)\>

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1570
...
> `readonly` **kind**: [`CaseBlock`](../enumerations/SyntaxKind.md#caseblock)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1568
...
> `readonly` **parent**: [`SwitchStatement`](SwitchStatement.md)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1569
