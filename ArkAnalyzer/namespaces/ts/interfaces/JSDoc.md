...
[ArkAnalyzer](../../../../globals.md) / [ts](../README.md) / JSDoc

# Interface: JSDoc

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1905
...
Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1909
...
> `readonly` **kind**: [`JSDoc`](../enumerations/SyntaxKind.md#jsdoc)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1906
...
> `readonly` **parent**: [`HasJSDoc`](../type-aliases/HasJSDoc.md)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1907
...
> `readonly` `optional` **tags**: [`NodeArray`](NodeArray.md)\<[`JSDocTag`](JSDocTag.md)\>

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1908
