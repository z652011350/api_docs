...
[ArkAnalyzer](../../../../globals.md) / [ts](../README.md) / AssertEntry

# Interface: AssertEntry

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1737
...
> `readonly` **kind**: [`AssertEntry`](../enumerations/SyntaxKind.md#assertentry)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1738
...
> `readonly` **name**: [`AssertionKey`](../type-aliases/AssertionKey.md)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1740

***

### parent

> `readonly` **parent**: [`AssertClause`](AssertClause.md)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1739
...
> `readonly` **value**: [`Expression`](Expression.md)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:1741
