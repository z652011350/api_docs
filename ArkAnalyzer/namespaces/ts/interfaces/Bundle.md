...
[ArkAnalyzer](../../../../globals.md) / [ts](../README.md) / Bundle

# Interface: Bundle

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:2158
...
> `readonly` **kind**: [`Bundle`](../enumerations/SyntaxKind.md#bundle)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:2159
...
> `readonly` **prepends**: readonly ([`InputFiles`](InputFiles.md) \| [`UnparsedSource`](UnparsedSource.md))[]

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:2160
...
> `readonly` **sourceFiles**: readonly [`SourceFile`](SourceFile.md)[]

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:2161
