...
[ArkAnalyzer](../../../../globals.md) / [ts](../README.md) / ArrayTypeNode

# Interface: ArrayTypeNode

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:968
...
> `readonly` **elementType**: [`TypeNode`](TypeNode.md)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:970
...
> `readonly` **kind**: [`ArrayType`](../enumerations/SyntaxKind.md#arraytype)

Defined in: node\_modules/ohos-typescript/lib/typescript.d.ts:969
